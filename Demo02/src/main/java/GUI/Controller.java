...
//        } catch (PetIsDirtyException | PocheshiPuzikoException | PetIsIllException | OopsYourShoesIsWetException | PetWantsToPalyException | PetIsHungryException e) {
...
//            } catch (PetIsDirtyException | PetIsHungryException e) {
//                printStateExceptionText(e.getMessage());
